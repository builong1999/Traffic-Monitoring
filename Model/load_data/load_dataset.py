...
class LoadDataset():
    def __init__(self,  real_img_path, density_path,
                        ...
                        epoch_data = 1,
                        threads = 4):
        self.data_folder_path = real_img_path + "/"
        self.density_folder_path = density_path + "/"
        self.now_data = 0
    ...
    def get_dataset(self):
        ...
        #Get Train data
            ...
            for image in self.train_data:
                ...
                temp_test.append(cv2.resize(np.asarray(gt_file['density']), (int(tshape[1]/8),int(tshape[0]/8))  )*64)
